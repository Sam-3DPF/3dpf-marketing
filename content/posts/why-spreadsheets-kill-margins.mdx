...
[3D PrintForce](https://app.3dprintforce.com/login?v=signup) is built for exactly this. It connects to Etsy, syncs your orders, tracks your print queue, and calculates profit per order automatically. The spreadsheet stays in a drawer where it belongs.
